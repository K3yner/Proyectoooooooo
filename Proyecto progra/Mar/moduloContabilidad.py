...
def añadirIngreso(ventas,fecha,productos,popUp_ingresos):
...
def añadirPago(popUp_pagos,recurrentes,pagos,marcar_Recurrente,marcar_Inversion,fecha,inversiones):
    ...
    #Botones aceptar y cancelar
    aceptar = tk.Button(popUp_pagos, text = "Aceptar", command = lambda: aceptarPago(popUp_pagos,cajaTexto1,cajaTexto2,pagos,marcar_Recurrente,marcar_Inversion,fecha,recurrentes,inversiones))
